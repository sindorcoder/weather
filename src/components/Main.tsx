          ...
          <div className="flex items-center w-full justify-end gap-10">
            <div className="flex items-center w-[40%]  justify-between gap-2 space-x-4 rounded-lg overflow-hidden text-[16px] sm:hidden">
              ...
              <div
                ...
                className={`fixed top-0  max-lg:backdrop-filter max-lg:backdrop-blur-3xl max-lg:bg-opacity-50 z-10 bg-zinc-600 -left-4 rounded-2xl overflow-hidden w-full h-full duration-700 ease-in-out   
                `}
              >
